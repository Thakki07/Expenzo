...
exports.spaceScaleKeys = exports.radii = exports.space = exports.sizes = exports.BORDER_RADIUS_SCALE_RATIOS = void 0;
...
const dynamicSpaceUnitsDefaultVar = (0, cssVariables_1.clerkCssVar)('spacing', SPACING_BASE_UNIT);
/**
 ...
 */
const calcDynamicSpaceUnits = (multiplier) => {
 ...
 */
const dynamicSpaceUnits = Object.freeze(Object.fromEntries(Object.entries(spacingScale).map(([key, { multiplier }]) => [key, calcDynamicSpaceUnits(multiplier)])));
/**
 ...
 */
exports.BORDER_RADIUS_SCALE_RATIOS = Object.freeze({
    sm: '2 / 3', // 0.66
    md: '1', // 1.0
    lg: '4 / 3', // 1.33
    xl: '2', // 2.0
});
const radiiDefaultVar = (0, cssVariables_1.clerkCssVar)('border-radius', '0.375rem');
const radii = Object.freeze({
    none: '0px',
    circle: '50%',
    avatar: (0, cssVariables_1.clerkCssVar)('border-radius-avatar', radiiDefaultVar),
    sm: (0, cssVariables_1.clerkCssVar)('border-radius-sm', `calc(${radiiDefaultVar} * ${exports.BORDER_RADIUS_SCALE_RATIOS.sm})`), // Use fraction for precision
    md: (0, cssVariables_1.clerkCssVar)('border-radius-md', radiiDefaultVar),
    lg: (0, cssVariables_1.clerkCssVar)('border-radius-lg', `calc(${radiiDefaultVar} * ${exports.BORDER_RADIUS_SCALE_RATIOS.lg})`), // Use fraction for precision
    xl: (0, cssVariables_1.clerkCssVar)('border-radius-xl', `calc(${radiiDefaultVar} * ${exports.BORDER_RADIUS_SCALE_RATIOS.xl})`),
    halfHeight: '99999px',
});
exports.radii = radii;
/**
 ...
 */
const spaceScaleKeys = Object.keys(spacingScale);
