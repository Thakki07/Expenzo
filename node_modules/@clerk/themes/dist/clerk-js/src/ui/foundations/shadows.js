...
exports.generateShadow = exports.shadows = exports.createShadowSet = void 0;
const utils_1 = require("../utils/colors/utils");
const cssSupports_1 = require("../utils/cssSupports");
const cssVariables_1 = require("../utils/cssVariables");
const generateShadow = (fn) => (color, alpha) => cssSupports_1.cssSupports.modernColor() ? fn(color, alpha) : `rgba(0, 0, 0, ${alpha})`;
 ...
 */
const createShadowSet = (shadowColor = '#000000', shadowGenerator = generateShadow((color, alpha) => (0, utils_1.createAlphaColorMixString)((0, cssVariables_1.clerkCssVar)('color-shadow', color), alpha * 100))) => {
...
exports.createShadowSet = createShadowSet;
// Default shadows using black shadow color
exports.shadows = Object.freeze((0, exports.createShadowSet)());
