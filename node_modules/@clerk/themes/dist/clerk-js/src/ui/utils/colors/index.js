...
exports.legacyColors = exports.modernColors = exports.colors = void 0;
const cssSupports_1 = require("../cssSupports");
const legacy_1 = require("./legacy");
Object.defineProperty(exports, "legacyColors", { enumerable: true, get: function () { return legacy_1.colors; } });
const modern_1 = require("./modern");
Object.defineProperty(exports, "modernColors", { enumerable: true, get: function () { return modern_1.colors; } });
exports.colors = {
    /**
     ...
     * ```
     */
    changeHslaLightness: legacy_1.colors.changeHslaLightness,
    /**
     ...
     * ```
     */
    setHslaAlpha: legacy_1.colors.setHslaAlpha,
    /**
    ...
    toHslaColor: (color) => {
        if (!color)
            return undefined;
        return cssSupports_1.cssSupports.modernColor() ? color : legacy_1.colors.toHslaColor(color);
    },
    /**
    ...
    toHslaString: (color) => {
        if (!color)
            return undefined;
        if (cssSupports_1.cssSupports.modernColor() && typeof color === 'string')
            return color;
        return legacy_1.colors.toHslaString(color);
    },
    /**
    ...
    lighten: (color, percentage = 0) => {
        if (cssSupports_1.cssSupports.modernColor()) {
            return modern_1.colors.lighten(color, percentage);
        }
        return legacy_1.colors.lighten(color, percentage);
    },
    /**
    ...
    makeTransparent: (color, percentage = 0) => {
        if (cssSupports_1.cssSupports.modernColor()) {
            return modern_1.colors.makeTransparent(color, percentage);
        }
        return legacy_1.colors.makeTransparent(color, percentage);
    },
    /**
    ...
    makeSolid: (color) => {
        if (cssSupports_1.cssSupports.modernColor()) {
            return modern_1.colors.makeSolid(color);
        }
        return legacy_1.colors.makeSolid(color);
    },
    /**
    ...
    setAlpha: (color, alpha) => {
        if (cssSupports_1.cssSupports.modernColor()) {
            return modern_1.colors.setAlpha(color, alpha);
        }
        return legacy_1.colors.setAlpha(color, alpha);
    },
    /**
    ...
    adjustForLightness: (color, lightness = 5) => {
        if (cssSupports_1.cssSupports.modernColor()) {
            return modern_1.colors.adjustForLightness(color, lightness);
        }
        return legacy_1.colors.adjustForLightness(color, lightness);
    },
};
